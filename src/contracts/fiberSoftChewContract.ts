...
export const fiberSoftChewContract: ContractData = {
  slug: 'fiber-soft-chew',
  ...
  fee: '$5,850',
  client: {
    name: 'Fiber Soft Chew CPG Brand',
    label: 'Client',
  ...
  scopePhases: [
    ...
    },
    {
      ...
      deliverable:
        'A complete starter identity system that gives the brand a clear visual and verbal foundation for packaging, social, digital, and future ecommerce.',
    },
    {
      label: 'D',

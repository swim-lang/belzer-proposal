...
test('Hike Doggie contract includes only Phase 1 and 2 with 75 and 25 payments', () => {
  ...
  assert.match(contract, /substantial front-loaded SOP extraction/)
  assert.match(contract, /reserves a concentrated production window/)
  assert.match(contract, /third-party AI, agent-processing, and technical-tool costs/)
  assert.match(contract, /Client-selected third-party platform subscriptions/)

...
test('Blanchet search visibility proposal is routed and scoped as a seven-day sprint', () => {
  ...
  assert.match(proposal, /Due to begin/)
  assert.match(proposal, /Google Business Profile eligibility and ownership check/)
  assert.match(proposal, /eligible Google Business Profile that can be claimed or updated/)
  assert.match(proposal, /LinkedIn and public attorney-profile recommendations/)
  assert.doesNotMatch(proposal, /50% to begin, 50% on completion/)
  assert.doesNotMatch(proposal, /\$2,500/)

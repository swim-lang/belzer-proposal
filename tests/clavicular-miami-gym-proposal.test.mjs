...
test('Clavicular proposal preserves the commercial terms and scope boundaries', () => {
  ...
  assert.match(proposal, /On-site work or travel/)
  assert.doesNotMatch(proposal, /Initial in-person Miami discovery travel/)
  assert.doesNotMatch(proposal, /In-person Miami discovery/)
  assert.doesNotMatch(proposal, /We start in person/)

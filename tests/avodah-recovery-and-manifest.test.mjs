...
test('Avodah presents all package terms, research, credit, and next steps', () => {
  ...
  assert.match(proposal, /\$20,000/)
  assert.match(proposal, /\$3,712\.50/)
  assert.match(proposal, /\$1,237\.50/)
  assert.match(proposal, /\$6,250/)
  assert.match(proposal, /\$3,125/)
  ...
  assert.match(proposal, /\/employment/)
  ...
  assert.match(proposal, /developers\.google\.com\/search\/docs\/essentials\/spam-policies/)
  assert.match(proposal, /support\.google\.com\/business\/answer\/3038177/)

...
test('Avodah presents the required research and two cumulative build layers', () => {
  ...
  assert.match(proposal, /Avodah Knowledge Library/)
  assert.match(proposal, /Educational Resource Site/)
  assert.match(proposal, /\$3,500/)
  assert.match(proposal, /\$7,000/)
  assert.match(proposal, /\$9,000/)
  assert.match(proposal, /\$10,500/)
  assert.match(proposal, /\$12,500/)
  assert.match(proposal, /\$19,500/)
  assert.match(proposal, /\$2,625/)
  assert.match(proposal, /\$875/)
  assert.match(proposal, /\$1,750/)
  assert.match(proposal, /\$4,500/)
  assert.match(proposal, /\$2,250/)
  ...
  assert.match(proposal, /searchable, listenable knowledge library/)
  assert.match(proposal, /Seven core pages: Home, Start Here, Workplace Problems, Rights and Remedies, Guides and Answers, Resource Directory, and About and Get Help/)
  ...
  assert.match(proposal, /Plain-language glossary of up to one hundred employment terms/)
  assert.match(proposal, /Six practical checklists and decision guides/)
  assert.match(proposal, /they will not be duplicated across domains/)

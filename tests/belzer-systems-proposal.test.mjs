...
test('Belzer client and firm systems proposal is registered with the agreed pricing', () => {
  ...
  assert.match(proposal, /\$15,800/)
  assert.match(proposal, /Approximately six weeks/)
  assert.match(proposal, /Approximately ten weeks/)
  assert.match(proposal, /second can be added later for the same \$7,900 investment/)
...
test('Belzer systems proposal includes milestone payments, support, and transparent value math', () => {
  ...
  assert.match(proposal, /\$3,950 for one system · \$7,900 for both/)
  assert.match(proposal, /\$1,975 for one system · \$3,950 for both/)
  ...
  assert.match(proposal, /Under 40 hours/)
  assert.match(proposal, /19\.75 hours/)
  assert.match(proposal, /39\.5 hours/)

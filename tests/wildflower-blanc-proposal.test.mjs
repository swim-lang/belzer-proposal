...
test('Wildflower + Blanc proposal is registered and preserves source content', () => {
  ...
  assert.match(proposal, /6-8 weeks/)
  assert.match(proposal, /Blanc Shopify website/)
  assert.match(contract, /Brand Identity and Blanc Shopify Website Agreement/)
  assert.match(contract, /fee: '\$16,900'/)
  assert.match(contract, /amount: '\$8,450'/)
  assert.match(contract, /amount: '\$4,225'/)
  assert.match(contract, /Blanc Shopify website/)
